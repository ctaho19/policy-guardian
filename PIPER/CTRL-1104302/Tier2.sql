...
EVALUATED_RESOURCES AS (
    ...
    AND CONTROL_ID = 'CM-8.AWS.33.v02'                    -- Filter for specific control
...
NON_COMPLIANT_COUNT AS (
    ...
    WHERE nc.CONTROL_ID = 'CM-8.AWS.33.v02'
...
SELECT 
    ...
    'MNTR-1104302-T2' AS MONITORING_METRIC_NUMBER,         -- Metric identifier
