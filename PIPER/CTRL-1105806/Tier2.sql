...
EVALUATED_RESOURCES AS (
    ...
    AND CONTROL_ID = 'AC-6.AWS.13.v02'                    -- Filter for specific control
...
NON_COMPLIANT_COUNT AS (
    ...
    WHERE nc.CONTROL_ID = 'AC-6.AWS.13.v02'
...
SELECT 
    ...
    'MNTR-1105806-T2' AS MONITORING_METRIC_NUMBER,         -- Metric identifier
