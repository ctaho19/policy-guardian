...
EVALUATED_RESOURCES AS (
    ...
    AND CONTROL_ID = 'CM-6.AWS.98.v01'                    -- Filter for specific control
...
NON_COMPLIANT_COUNT AS (
    ...
    WHERE nc.CONTROL_ID = 'CM-6.AWS.98.v01'
...
SELECT 
    ...
    'MNTR-1077962-T2' AS MONITORING_METRIC_NUMBER,         -- Metric identifier
