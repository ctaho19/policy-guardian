...
EVALUATED_RESOURCES AS (
    ...
    AND CONTROL_ID = 'AC-3.AWS.136.v02'                    -- Filter for specific control
...
NON_COMPLIANT_COUNT AS (
    ...
    WHERE nc.CONTROL_ID = 'AC-3.AWS.136.v02'
...
SELECT 
    ...
    'MNTR-1106070-T2' AS MONITORING_METRIC_NUMBER,         -- Metric identifier
