...
EVALUATED_RESOURCES AS (
    ...
    AND CONTROL_ID = 'CM-2.AWS.10.v02'                    -- Filter for specific control
...
NON_COMPLIANT_COUNT AS (
    ...
    WHERE nc.CONTROL_ID = 'CM-2.AWS.10.v02'
...
SELECT 
    ...
    'MNTR-1071822-T2' AS MONITORING_METRIC_NUMBER,         -- Metric identifier
